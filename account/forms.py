...
class KYCForm(forms.ModelForm):
    ...
    class Meta:
        model = KYC
        fields = ['full_name', 'image','gender', 'identity_type', 'identity_image', 'date_of_birth', 'signature', 'country', 'state', 'city', 'mobile', 'fax']
...
#         widgets = {
#             "pin_number": forms.TextInput(attrs={"placeholder":"Transaction_Pin"}),
